...
import com.brymm.brymmapp.local.MenusDiaActivity;
...
@SuppressLint("NewApi")
public class CalendarioMenusFragment extends Fragment {	
	...
	private void inicializar() {
		...
		adapter = new CalendarAdapter(getActivity(), month,R.layout.calendar_menu_item);
		...
		gridview.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View v,
				...
				if (date instanceof TextView && !date.getText().equals("")) {
					...
					Intent intent = new Intent(getActivity(),MenusDiaActivity.class);
					intent.putExtra(
							ListaMenusDiaFragment.EXTRA_FECHA,
	...
	public Runnable calendarUpdater = new Runnable() {
		...
		public void run() {
			...
			items = (ArrayList<String>) gestor
					.obtenerDiasMenuMes(android.text.format.DateFormat
